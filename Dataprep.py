...
if __name__ == '__main__':
    ...
    Path(os.path.dirname(maindir  + '/Database/Training_Samples/Train')).mkdir(parents=True, exist_ok=True)
    Path(os.path.dirname(maindir  + '/Database/Training_Samples/Dev')).mkdir(parents=True, exist_ok=True)

    savechunks(maindir  + '/scpfiles/Train.txt', maindir +'/Database/Training_Samples/Train')
    savechunks(maindir  + '/scpfiles/Dev.txt', maindir  + '/Database/Training_Samples/Dev')
